// Reproduced from https://github.com/Faithlife/FaithlifeUtility/blob/master/src/Faithlife.Utility/GuidUtility.cs
// All credit to Bradley Grainger and Ed Ball
...
namespace Halogen.Core
{
	...
	public static class GuidUtility
	{
		...
		public static Guid FromLowerNoDashString(string value)
		{
			...
			if (guid == null)
				throw new FormatException(string.Format("The string '{0}' is not a no-dash lowercase GUID.", value ?? "(null)"));
			return guid.Value;
		}
        ...
        public static readonly Guid HalogenNamespace = new Guid("62ecfaae-f470-4669-b095-16ac1b7be910");
